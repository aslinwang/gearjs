...
exports.mkdir = function(path, basePath, callback){
  ...
  if(!dirs.length){
    ...
    return exports.mkdir(dirs.join(p.sep), root, callback);
  }
 ...
 * @param  {array} namereplace  目标文件名替换正则数组,可为数组，可为返回数组的方法
...
exports.copyFile = function(src, tarDir, namereplace, basePath){
  ...
  tarfile = file;
  if(namereplace){
    if(typeof namereplace == 'function'){
      namereplace = namereplace(file);
    }
